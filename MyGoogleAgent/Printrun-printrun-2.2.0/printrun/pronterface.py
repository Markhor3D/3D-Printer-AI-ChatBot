...
class PronterWindow(MainWindow, pronsole.pronsole):
    ...
    def reload_ui(self, *args):
        ...
        if self.settings.uimode in (_("Tabbed"), _("Tabbed with platers"), _("Tabbed with chat")):
...
Printrun. If not, see <http://www.gnu.org/licenses/>."""
    ...
    def _add_settings(self, size):
        ...
        self.settings._add(ComboSetting("uimode", _("Tabbed with chat"), [_("Standard"), _("Compact"), _("Tabbed"), _("Tabbed with platers"), _("Tabbed with chat")], _("Interface mode"), _("Standard interface is a one-page, three columns layout with controls/visualization/log\nCompact mode is a one-page, two columns layout with controls + log/visualization\nTabbed interface modes use tabs to organize controls, status, and potentially platers or a chatbot."), "UI"), self.reload_ui)
