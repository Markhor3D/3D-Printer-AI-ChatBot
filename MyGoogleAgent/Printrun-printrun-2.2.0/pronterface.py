...
# Add MyGoogleAgent and the current directory to sys.path for chatbot module discovery
# The pronterface.py is in C:\GeminiCli\MyGoogleAgent\Printrun-printrun-2.2.0
# We need to add C:\GeminiCli\MyGoogleAgent and C:\GeminiCli\MyGoogleAgent\Printrun-printrun-2.2.0 to sys.path
my_google_agent_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..'))
if my_google_agent_path not in sys.path:
    sys.path.insert(0, my_google_agent_path)
